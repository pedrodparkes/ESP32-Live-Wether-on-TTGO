...
const char* ssid     = "WhereTheWildThingsAre1";       ///EDIIIT
const char* password = "gfhfgfgfgfv"; //EDI8IT
String town="Odessa";              //EDDIT
String Country="UA";                //EDDIT
const String endpoint = "http://api.openweathermap.org/data/2.5/weather?q="+town+","+Country+"&units=metric&APPID=";
const String key = "9ce59dafaf31a3bd7599ec9aa9325980"; /*EDDITTTTTTTTTTTTTTTTTTTTTTTT                      */
